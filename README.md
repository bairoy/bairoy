...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=36BCF7&center=true&vCenter=true&width=750&height=60&lines=Backend+Engineer+%7C+Node.js+%2B+TypeScript;System+design+%26+scalable+distributed+services;Also+building+multi-agent+AI+systems;Open+to+backend+and+SWE+internships" alt="Typing SVG" />
  </a>
</p>
...
- ⚙️ Backend-focused: Node.js + TypeScript services, API design, and system architecture — with a long-term goal of working in fintech
- 🔨 Currently building **[krimicode](https://github.com/bairoy/KRIMICODE)**, a terminal coding agent in TypeScript, and **FutureEdge**, a multi-agent AI trading system
- 💬 Ask me about designing scalable backends, TypeScript service architecture, or LangGraph agent workflows
- 🌐 Portfolio (with a RAG chatbot that answers questions about my work): **[baiju-yadav.netlify.app](https://baiju-yadav.netlify.app/)**
- 📫 Best way to reach me: **[LinkedIn](https://linkedin.com/in/baiju-yadav-7127b72b4)**
...
| :--- | :--- | :--- |
| **[krimicode](https://github.com/bairoy/KRIMICODE)** | Terminal coding agent in TypeScript — reads and edits your project, runs commands, and asks before anything that writes or executes. Nine tools behind a permission model that classifies calls by *intent* rather than tool identity, workspace-sandboxed path resolution, session persistence with secret redaction, and automatic context compaction. Runs against any OpenAI-compatible endpoint. | `TypeScript` `Node.js` `LLM tooling` |
...
<img src="https://img.shields.io/badge/Next.js%2014-000000?style=flat&logo=next.js&logoColor=white">
</p>
...
<img src="https://img.shields.io/badge/MCP-1C3C3C?style=flat">
</p>
...
<p align="center"><i>Open to AI/ML and software engineering internship opportunities.</i></p>
